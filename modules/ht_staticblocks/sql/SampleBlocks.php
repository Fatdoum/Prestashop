            ...
            <div id="parallax-section" class="parallax-section">
                            <div class="latest-offer-section">
                                <div class="offer-inner">
                                    ...
                                    <a href="https://www.hiddentechies.com/bentriz-pro-responsive-theme-prestashop.html">Download Now</a></div>
                            </div>
                        </div>
';
        $content_block3 = '
                        ...
                        <div class="footer-column-content footer-block-toggle-content">
                            <div class="content">
                                ...
                                <p class="email">
                                    ...
                                    <span>
                                        <a href="mailto:demo@mydomain.com" title="Mail to: demo@mydomain.com">demo@mydomain.com</a>
                                    </span>
                                </p>
                                <p class="phone">
                                    <strong>
